...
function focusMoon(m){
  ...
  ['hud-moons-row','hud-gravity-row','hud-temp-row','hud-density-row','hud-escape-row','hud-incl-row'].forEach(function(id){
    const el = document.getElementById(id); if(el) el.style.display = 'none';
  });
  const ml = document.getElementById('hud-moon-list'); if(ml){ ml.innerHTML=''; ml.style.display='none'; }
